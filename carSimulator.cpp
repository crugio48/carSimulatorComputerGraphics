...
struct Vertex {
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions() {
        ...
        attributeDescriptions[0].format = VK_FORMAT_R32G32_SFLOAT;  //vec2 pos
        attributeDescriptions[0].offset = offsetof(Vertex, pos);

        attributeDescriptions[1].binding = 0;
        attributeDescriptions[1].location = 1;
        attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;   //vec3 color
...
private:
    ...
    void createRenderPass() {
        ...
        VkAttachmentReference colorAttachmentRef{};  //attachment per subpass
        colorAttachmentRef.attachment = 0;
        colorAttachmentRef.layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;

        VkSubpassDescription subpass{};   //rendering subpasses
    ...
    void createDescriptorSetLayout() {
        ...
        uboLayoutBinding.descriptorCount = 1;                              //very interesting -> lookup for rotating wheels differently to car
